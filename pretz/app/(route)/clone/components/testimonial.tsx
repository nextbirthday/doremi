    ...
    <section id="testimonial" className={styles.section}>
      ...
      <ul className={styles.testimonials}>
        <li className={styles.testimonial}>
          <img src="images/blue_archive_cutscene/BG_CS_PR_08.jpg" alt="people1" className={styles.testimonial__image} />
          <div className={styles.testimonial__bubble}>
            ...
            <p>
              <a href="#" className={styles.testimonial__bubble__name}>
                Shiroko
              </a>
              Abydos
            </p>
        ...
        <li className={styles.testimonial}>
          <img src="images/blue_archive_cutscene/BG_CS_PV4_075.jpg" alt="people1" className={styles.testimonial__image} />
          <div className={styles.testimonial__bubble}>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. A consectetur suscipit quia mollitia amet, vero inventore aliquid quaerat similique voluptates ipsam sunt
              maxime maiores odit accusamus nihil, facere accusantium dolores. <br />
        ...
        <li className={styles.testimonial}>
          <img src="images/blue_archive_cutscene/BG_CS_S1Final_27_2.jpg" alt="people1" className={styles.testimonial__image} />
          <div className={styles.testimonial__bubble}>
            <p>
